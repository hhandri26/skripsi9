...
class UsulankerjasamaController extends Controller {
	...
	public $module = 'usulankerjasama';
	static $per_page	= '50';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Usulankerjasama();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'usulankerjasama',
	...
	public static function display(  )
	{
		...
		$model  = new Usulankerjasama();
		$info = $model::makeInfo('usulankerjasama');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('usulankerjasama.public.view',$data);			
			}			
		} 
		else {
			...
			return view('usulankerjasama.public.index',$data);	
		}
